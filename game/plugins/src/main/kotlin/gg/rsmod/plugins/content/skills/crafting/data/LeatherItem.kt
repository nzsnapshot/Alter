...
import gg.rsmod.plugins.api.cfg.Items
    ...
    GREEN_DHIDE_VAMB(id = Items.GREEN_DHIDE_VAMBRACES, leatherCount = 1, level = 57, craftXp = 62.0),
    ...
    BLUE_DHIDE_VAMB(id = Items.BLUE_DHIDE_VAMBRACES, leatherCount = 1, level = 66, craftXp = 70.0),
    ...
    RED_DHIDE_VAMB(id = Items.RED_DHIDE_VAMBRACES, leatherCount = 1, level = 73, craftXp = 78.0),
    ...
    BLACK_DHIDE_VAMB(id = Items.BLACK_DHIDE_VAMBRACES, leatherCount = 1, level = 79, craftXp = 86.0),
