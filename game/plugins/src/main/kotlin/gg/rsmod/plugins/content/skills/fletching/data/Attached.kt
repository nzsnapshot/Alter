...
enum class Attached(val id: Int, val toolRequired: Int = -1, val firstMaterial: Int, val secondMaterial: Int, val level: Int, val animation: Int, val fletchingXP: Double) {
    ...
    MITH_CROSSBOW(id = Items.MITHRIL_CROSSBOW, firstMaterial = Items.MITHRIL_CROSSBOW_U, secondMaterial = Items.CROSSBOW_STRING, level = 54, animation = 6675, fletchingXP = 32.0),
